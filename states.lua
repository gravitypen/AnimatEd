...
states = {
	...
	-- Mouse interaction
	inactiveMouse = {active = false, x = -9999, y = -9999, leftclick = 0, rightclick = 0},
	activeMouse = {active = true, x = 0, y = 0, leftclick = 0, rightclick = 0},
	mouse = nil,
	-- Misc
	scissorX1 = 0,
...
function states.drawTransitionBar(x, targetState)
	...
	-- Draw
	love.graphics.setColor(hover and {140,140,140,255} or {120,120,120,255})
	love.graphics.rectangle("fill", x1,y1,x2-x1,y2-y1)
	-- Arrows depend on position on screen?
	-- ...
	love.graphics.setColor(0,0,0, hover and 255 or 220)
	local y = (y1+y2)/2
	-- Arrow to Left on Right side
	love.graphics.line(x+10,y, x+22,y-20)
	love.graphics.line(x+10,y, x+22,y+20)
